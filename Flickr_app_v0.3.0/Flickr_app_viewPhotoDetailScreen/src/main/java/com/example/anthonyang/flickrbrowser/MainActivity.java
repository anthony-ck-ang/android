...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        mRecycleView.addOnItemTouchListener(new RecyclerItemClickListener(this, mRecycleView,
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemLongClick(View view, int position) {
                        ...
                        //onLongClick -> create and implement intent -> move to photoDetail view
                        Intent intent = new Intent(MainActivity.this, ViewPhotoDetailsActivity.class);
                        //retrieve PhotoObject at specific position -> put in intent -> sent it to ViewPhotoDetailsActivity
                        intent.putExtra(PHOTO_TRANSFER, flickrRecyclerViewAdapter.getPhoto(position)); //position is passed automatically whenever user click recyclerView
